    ...
    const loadData = async () => {
        ...
        try {
            const [fetchedApplications, fetchedResumes, vaultList] = await Promise.all([
                jobApplicationAPI.getAll({ sort: "-created_date", limit: 10 }),
                resumeAPI.getAll({ sort: "-created_date", limit: 5 }),
                autofillVaultAPI.getAll({ sort: "-updated_date", limit: 1 })
            ]);
                    ...
                    <div className="space-y-6">
                        <PlanBadge
                            ...
                            usage={{
                                ...
                                coverLetters: applications.filter(app => app.cover_letter).length
                            }}
                        />
