...
export default function MyResumes() {
    ...
    const handleFileUpload = async (file) => {
        ...
        try {
            // Use Backend API to parse file via Kyle Agent
            const parseResult = await resumeAPI.parse(file);
            ...
            const parsedObj = parseResult.output || {};
            const file_url = parseResult.file_url || ""; // Placeholder URL from backend
