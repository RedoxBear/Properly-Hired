...
const items = [
  { title: "Double Column", description: "Two-column layout with achievements sidebar.", url: "/vite.svg" },
  { title: "Ivy League", description: "Classic, academic-friendly structure.", url: "/vite.svg" },
  { title: "Elegant", description: "Right-side highlight panel, clean body.", url: "/vite.svg" },
  { title: "Contemporary", description: "Bold shapes with modern accents.", url: "/vite.svg" },
  { title: "Polished", description: "Presentation-first with strong sidebar.", url: "/vite.svg" },
  { title: "Timeline", description: "Reverse-chronological focus with milestones.", url: "/vite.svg" },
  { title: "Creative", description: "Invites recruiters to explore your story.", url: "/vite.svg" },
