...
const ENTITY_MAP = {
  ...
  "Education_Training_and_Experience.csv":           { entity: "ONetReference", mapper: mapEducation },
  "Education_Training_and_Experience_Categories.csv":{ entity: "ONetReference", mapper: mapGenericRef("Education_Categories") },
  "Interests.csv":                                  { entity: "ONetReference", mapper: mapScoredElement("Interests") },
  "Work_Styles.csv":                                { entity: "ONetReference", mapper: mapScoredElement("Work_Styles") },
  "Work_Values.csv":                                { entity: "ONetReference", mapper: mapScoredElement("Work_Values") },
